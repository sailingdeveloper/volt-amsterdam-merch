...
function showToast(message, type = 'success', link = null) {
    ...
    const linkHtml = link ? `<a href="${link.url}" class="text-sm font-medium underline hover:no-underline mt-2 block text-right">${link.text}</a>` : '';
    
    toast.innerHTML = `
        <div class="rounded-lg ${bgColor} text-white px-4 py-3 shadow-lg">
